...
supabase: Client = create_client(
    ...
    os.getenv("SUPABASE_SERVICE_ROLE_KEY")  # используйте этот ключ
)
...
def exchange_rates():
    # Позже можно заменить на данные из Supabase
    return {
        "rates": [
            ...
            {"code": "KZT", "rate": 0.21, "name": "Тенге", "flag": "🇰🇿"},
            {"code": "UZS", "rate": 0.0075, "name": "Сум", "flag": "🇺🇿"},
            {"code": "TJS", "rate": 8.5, "name": "Сомони", "flag": "🇹🇯"}
        ]
    }